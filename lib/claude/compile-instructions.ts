...
const CompiledSchema = z.object({
  ...
  notes: z
    .string()
    .describe(
      "One or two sentences for the user: what you understood, and anything you could not honor and why."
    ),
});
...
- Bullet rules ("- "), imperative voice, ONE observable behavior per rule. At most 12 rules and 250 words.
...
If the wish contains nothing actionable, return an empty compiled string and say so kindly in notes.`;
